  ...
  <div class="aplikasi-tipecontainer-page">
    <div class="page-header">
      ...
      <div class="breadcrumb">
        <RouterLink to="/" title="/">Home</RouterLink> &gt; <RouterLink to="/pengaturan/aplikasi" title="/pengaturan/aplikasi">Pengaturan Aplikasi</RouterLink> &gt; <span>Tipe Container</span>
      </div>
    </div>
